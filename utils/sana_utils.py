...
from diffusers.pipelines.sana.pipeline_sana import ASPECT_RATIO_4096_BIN, retrieve_timesteps
...
# Copied from SanPipeline, the same way ESD implemented the SD `run_till_timestep` functionality
...
def esd_sana_call(
    ...
    # THIS IS THE ONLY CODE THAT DOESNT APPEAR IN THE ORIGINAL SANA FUNC:
    ### FROM HERE ########################################
    ################################################################################
