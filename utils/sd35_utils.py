...
# Copied from StableDiffusion3Pipeline, the same way ESD implemented the SD `run_till_timestep` functionality
...
def esd_sd35_call(
    ...
    # THIS IS THE ONLY CODE THAT DOESNT APPEAR IN THE ORIGINAL SD35 FUNC:
    ### FROM HERE ########################################
    ################################################################################
